                        ...
                        if (fileStats.isDirectory()) {
                            ...
                            return Q.Promise(function (resolve, reject, notify) {
                                ...
                                if (exists) {
                                    ...
                                    return Q.nfcall(fs.readFile, resourcePath_1, "utf8").then(function (contents) {
        ...
        if (fs.lstatSync(fsPath).isDirectory()) {
            ...
            if (fileDecl.partName || fileDecl.packagePath) {
                ...
                if (typeof partName === "string") {
                    ...
                    partName = partName.map(function (pn) { return utils_1.toZipItemName(utils_1.forwardSlashesPath(_.trimEnd(pn, "/") + relativePath_1.substr(fileDecl.path.length))); });
                }
            }
            files.push({
                path: relativePath_1,
