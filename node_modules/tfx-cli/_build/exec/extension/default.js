...
var ExtensionBase = (function (_super) {
    ...
    function ExtensionBase(passedArgs) {
        ...
        _this.description = "Commands to package, publish, and manage Extensions for Visual Studio Team Services.";
    ...
    ExtensionBase.prototype.getMergeSettings = function () {
        return Promise.all([
            ...
            var root = values[0], locRoot = values[1], manifests = values[2], manifestGlob = values[3], override = values[4], overridesFile = values[5], revVersion = values[6], bypassValidation = values[7], publisher = values[8], extensionId = values[9];
            if (publisher) {
