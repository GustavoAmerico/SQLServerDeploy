...
var ExtensionPublish = (function (_super) {
    ...
    ExtensionPublish.prototype.exec = function () {
        return __awaiter(this, void 0, void 0, function () {
            var galleryApi, result, publishSettings, extensionCreatePromise, createdExtensionVsixPath, _a, mergeSettings, packageSettings, createdExtension, packagePublisher, publishedExtension, sharingMgr;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!publishSettings.vsixPath) return [3 /*break*/, 2];
                        result.packaged = null;
                        createdExtensionVsixPath = publishSettings.vsixPath;
                        return [3 /*break*/, 5];
                    case 2: return [4 /*yield*/, Promise.all([this.getMergeSettings(), this.getPackageSettings()])];
                    case 3:
                    ...
                    case 6:
                        ...
                        if (!(publishSettings.shareWith && publishSettings.shareWith.length >= 0)) return [3 /*break*/, 8];
